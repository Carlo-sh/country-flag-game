...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   flagsData: () => (/* reexport safe */ _gameLogic__WEBPACK_IMPORTED_MODULE_0__.flagsData),\n/* harmony export */   garbage: () => (/* reexport safe */ _gameLogic__WEBPACK_IMPORTED_MODULE_0__.garbage),\n/* harmony export */   generateGameGrid: () => (/* binding */ generateGameGrid),\n/* harmony export */   lives: () => (/* reexport safe */ _gameLogic__WEBPACK_IMPORTED_MODULE_0__.lives),\n/* harmony export */   playGame: () => (/* reexport safe */ _gameLogic__WEBPACK_IMPORTED_MODULE_0__.playGame),\n/* harmony export */   score: () => (/* reexport safe */ _gameLogic__WEBPACK_IMPORTED_MODULE_0__.score)\n/* harmony export */ });\n/* harmony import */ var _gameLogic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gameLogic */ \"./src/gameLogic.js\");\n\n\nconst yScore = document.getElementById('your-score');\nconst livesWrapper = document.getElementById('lives-wrapper');\n\nconst generateGameGrid = () => {\n\tif (_gameLogic__WEBPACK_IMPORTED_MODULE_0__.flagsData.length < 4) {\n\t\tcontent.innerHTML = `<h1>You have guessed all the flags!</h1>`;\n\t\treturn;\n\t}\n\tif (content.innerHTML === `<h1>Game Over</h1>`) return;\n\tcontent.innerHTML = '';\n\tconst flagContainer = document.createElement('div');\n\tflagContainer.setAttribute('id', 'flag-container');\n\tlet cNames = [];\n\tlet cIndexes = [];\n\n\twhile (cNames.length < 4) {\n\t\tlet idx = Math.floor(Math.random() * _gameLogic__WEBPACK_IMPORTED_MODULE_0__.flagsData.length);\n\t\tif (!cNames.includes(_gameLogic__WEBPACK_IMPORTED_MODULE_0__.flagsData[idx].country)) {\n\t\t\tcNames.push(_gameLogic__WEBPACK_IMPORTED_MODULE_0__.flagsData[idx].country);\n\t\t\tcIndexes.push(idx);\n\n\t\t\tconst flagWrapper = document.createElement('div');\n\t\t\tflagWrapper.classList.add('flag-wrapper', 'flag-light');\n\t\t\tflagWrapper.setAttribute('name', `${_gameLogic__WEBPACK_IMPORTED_MODULE_0__.flagsData[idx].country}`);\n\n\t\t\tconst flag = new Image();\n\t\t\tflag.src = _gameLogic__WEBPACK_IMPORTED_MODULE_0__.flagsData[idx].flag;\n\t\t\tflag.classList.add('flag');\n\n\t\t\tflagWrapper.appendChild(flag);\n\t\t\tflagContainer.appendChild(flagWrapper);\n\t\t}\n\t}\n\n\tlet guessIdx = Math.floor(Math.random() * cNames.length);\n\n\tconst guessCountry = document.createElement('h2');\n\tguessCountry.textContent = cNames[guessIdx];\n\tlet fGuess = guessCountry.textContent;\n\tcontent.append(flagContainer, guessCountry);\n\n\tconst flagWrappers = document.querySelectorAll('.flag-wrapper');\n\n\tflagWrappers.forEach(el => {\n\t\tel.addEventListener('click', () => {\n\t\t\tflagWrappers.forEach(el => {\n\t\t\t\tel.classList.remove('flag-light');\n\t\t\t\tel.classList.add('disable-div');\n\t\t\t});\n\n\t\t\tconst cName = el.getAttribute('name');\n\n\t\t\t(0,_gameLogic__WEBPACK_IMPORTED_MODULE_0__.playGame)(el, cNames, cIndexes, cName, fGuess, yScore, livesWrapper);\n\t\t\tsetTimeout(generateGameGrid, 1000);\n\t\t});\n\t});\n};\n\n\n\n\n//# sourceURL=webpack://country-flag-game/./src/generate.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _icons_heart_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../icons/heart.svg */ \"./icons/heart.svg\");\n/* harmony import */ var _generate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./generate */ \"./src/generate.js\");\n\n\n\n\nconst content = document.getElementById('content');\nconst flagContainer = document.getElementById('flag-container');\nconst livesWrapper = document.getElementById('lives-wrapper');\nconst yourScore = document.getElementById('your-score');\n\n(function () {\n\tfor (let i = 0; i < 3; i++) {\n\t\tconst heartIcon = new Image();\n\t\theartIcon.src = _icons_heart_svg__WEBPACK_IMPORTED_MODULE_1__;\n\t\tlivesWrapper.appendChild(heartIcon);\n\t}\n\n\tlet cNames = [];\n\tlet cIndexes = [];\n\n\twhile (cNames.length < 4) {\n\t\tlet idx = Math.floor(Math.random() * _generate__WEBPACK_IMPORTED_MODULE_2__.flagsData.length);\n\t\tif (!cNames.includes(_generate__WEBPACK_IMPORTED_MODULE_2__.flagsData[idx].country)) {\n\t\t\tcNames.push(_generate__WEBPACK_IMPORTED_MODULE_2__.flagsData[idx].country);\n\t\t\tcIndexes.push(idx);\n\n\t\t\tconst flagWrapper = document.createElement('div');\n\t\t\tflagWrapper.classList.add('flag-wrapper', 'flag-light');\n\t\t\tflagWrapper.setAttribute('name', `${_generate__WEBPACK_IMPORTED_MODULE_2__.flagsData[idx].country}`);\n\n\t\t\tconst flag = new Image();\n\t\t\tflag.src = _generate__WEBPACK_IMPORTED_MODULE_2__.flagsData[idx].flag;\n\t\t\tflag.classList.add('flag');\n\n\t\t\tflagWrapper.appendChild(flag);\n\t\t\tflagContainer.appendChild(flagWrapper);\n\t\t}\n\t}\n\n\tlet guessIdx = Math.floor(Math.random() * cNames.length);\n\n\tconst guessCountry = document.createElement('h2');\n\tguessCountry.textContent = cNames[guessIdx];\n\tlet guess = guessCountry.textContent;\n\tcontent.append(flagContainer, guessCountry);\n\n\tconst flagWrappers = document.querySelectorAll('.flag-wrapper');\n\n\tflagWrappers.forEach(el => {\n\t\tel.addEventListener('click', () => {\n\t\t\tflagWrappers.forEach(el => {\n\t\t\t\tel.classList.remove('flag-light');\n\t\t\t\tel.classList.add('disable-div');\n\t\t\t});\n\t\t\tconst cName = el.getAttribute('name');\n\t\t\t(0,_generate__WEBPACK_IMPORTED_MODULE_2__.playGame)(el, cNames, cIndexes, cName, guess, yourScore, livesWrapper);\n\t\t\tsetTimeout(_generate__WEBPACK_IMPORTED_MODULE_2__.generateGameGrid, 1000);\n\t\t});\n\t});\n})();\n\n\n//# sourceURL=webpack://country-flag-game/./src/index.js?");
